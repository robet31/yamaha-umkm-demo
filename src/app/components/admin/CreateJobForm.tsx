...
export function CreateJobForm({ onCancel, onSuccess }: CreateJobFormProps) {
  const [submitting, setSubmitting] = useState(false);

  // Form states - Manual input
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      const bookingPayload = {
        user_id: null, // Admin creates without user_id
        vehicle_id: null,
        ...
        notes: [
          ...
          vehicleName ? `🏍️ Kendaraan: ${vehicleName}` : null,
          `📦 Paket: Custom Service`,
          `⏰ Waktu: ${selectedTime}`,
          `💰 Service Fee: Rp ${serviceFee.toLocaleString('id-ID')}`,
          notes ? `\n📝 ${notes}` : null
        ].filter(Boolean).join('\n'),
        amount: grandTotal,
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Buat Job Order Baru</h1>
                  <p className="text-sm text-gray-600">Harga jasa service <span className="font-bold text-green-600">Rp 25.000</span></p>
                </div>
              </div>
            </div>
            ...
            <Button
              ...
              className="bg-green-600 hover:bg-green-700 text-white h-12 px-8 text-base shadow-lg"
            >
              {submitting ? (
                <>
      ...
      <div className="max-w-[1600px] mx-auto px-8 py-8">
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-5 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <Label className="text-base mb-2 block">Atas Nama *</Label>
                  <Input
                ...
                <div>
                  <Label className="text-base mb-2 block">Nama Kendaraan (Opsional)</Label>
                  <Input
                    ...
                    className="h-12 text-base"
                  />
                  <p className="text-xs text-gray-500 mt-1">Isi jika ada info kendaraan</p>
                </div>
              </CardContent>
            </Card>
          ...
          {/* RIGHT COLUMN - Sparepart & Summary */}
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <Badge 
                              ...
                              className={`text-xs ${item.stock > 0 ? 'bg-green-100 text-green-800' : ''}`}
                            >
                              {item.stock}
                            </Badge>
                          </div>
